...
the circular block bootstrap to create training set bootstrap samples.
...
def _parallel_build_estimators(
    ...
    for i in range(n_estimators):
        ...
        features, indices = circular_block_generate_bagging_indices(
            random_state,
            bootstrap_features,
            bootstrap,
            n_features,
...
class CircularBlockBaggingRegressor(BaggingRegressor):
    def __init__(
            self,
            estimator=None,
            n_estimators=10,
    ...
    def _get_estimators_indices(self):
        ...
        for seed in self._seeds:
            ...
            feature_indices, sample_indices = circular_block_generate_bagging_indices(
                seed,
